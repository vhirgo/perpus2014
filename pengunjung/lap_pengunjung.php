...
<tr><td class="head-data" colspan="2">Data Pengunjung Per kelas, bulan <?php echo date('F')." ".date('Y'); ?></td></tr>
<tr><td class='pinggir-data'>Kelas 7 A</td><td align="center" class='td-data'><b><?php echo $ta; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 7 B</td><td align="center" class='td-data'><b><?php echo $tb; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 7 C</td><td align="center" class='td-data'><b><?php echo $tc; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 8 A</td><td align="center" class='td-data'><b><?php echo $da; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 8 B</td><td align="center" class='td-data'><b><?php echo $db; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 8 C</td><td align="center" class='td-data'><b><?php echo $dc; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 9 A</td><td align="center" class='td-data'><b><?php echo $sa; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 9 B</td><td align="center" class='td-data'><b><?php echo $sb; ?></b></td></tr>
<tr><td class='pinggir-data'>Kelas 9 C</td><td align="center" class='td-data'><b><?php echo $sc; ?></b></td></tr>
